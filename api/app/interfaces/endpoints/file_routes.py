...
async def download_file(
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": f"{'inline' if inline else 'attachment'}; filename*=utf-8''{encoded_filename}",
...
async def delete_file(
    ...
    """删除指定文件"""
    fileinfo = await file_service.delete_file(file_id)
    return Response.success(
        msg="删除文件成功",
        data=fileinfo,
    )
